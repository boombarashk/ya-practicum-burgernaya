...
const useScroll = () => {
  ...
  const onHandleScroll = (e) => {
    ...
    headers.forEach((header) => {
      ...
      if (headerRect.top >= scrollContainerRect.top && headerRect.bottom <= scrollContainerRect.bottom) {
          const distanceToTop = Math.abs(headerRect.top - scrollContainerRect.top);
