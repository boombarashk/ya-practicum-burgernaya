    ...
    reducers: {
        ...
        addIngredient(state, action) {
            ...
            if (action.payload.type === TYPE_INGREDIENT[0].param) {
                ...
                state.data.push({...reduceInfo(action.payload), id: cryptoRandomString({
                    length: 8,
                    type: 'base64'
                })})
...
export const { addIngredient, deleteIngredient, sortIngredients, resetConstructor } = constructorSlice.actions
